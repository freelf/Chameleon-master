...
- (IBAction)action:(NSTextField *)sender
{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"ConsoleWindowController" object:nil userInfo:@{@"text":sender.stringValue}];
}
